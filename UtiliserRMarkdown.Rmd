...
Les remarques précédentes sont valides pour tous type de code, mais on très est
souvent intéressé par ajouter les tables et figures produites avec R et il y a
un certain nombre de paramètres qui peuvent être utilisés.
