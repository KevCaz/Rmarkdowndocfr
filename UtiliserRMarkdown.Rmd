...
et mon fichier est créé! Pour les utilisateurs de R Studio, cela peut se faire
en 2 clics, comme illustré sur les figures qui suivent. L’intérêt d'utiliser R
Studio est que le fichier créé contient des indications relatives à
l'utilisation du fichier en question!
...
## Spécifier les documents à obtenir avec le fichier YAML

<!-- KC: J'en suis la a relire -->
**WIP**
