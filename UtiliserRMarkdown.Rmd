...
avec R dans un document, le plus simple est de regarder ce que nous génère
...
<!-- mettre une application carto à la place -->


Je souhaite faire un modèle linéaire avec la variable explicative *var1* et la
variable à expliquer *var2* de notre *tab1*. Nous créons alors un petit
...
Dans cette section, je fais une mention rapide de quelques fonctionnalités que
je qualifie d'avancées, au sens ou leur utilisation est peut-être moisn répandue
et leurs intérêt mois évident pour l'utilisateur débutant.
...
## Utiliser du code depuis un script externe
